...
Original file is located at
    https://colab.research.google.com/drive/1YcoEx3O5GLBiZsP6QrtzZ3U2CXiey91U
...
Create a sphere that can be interacted with (representing the Earth). 


Extract geolocation data from the NASA meteorite data and plot it onto the Earth at the corresponding locations.
"""
...
layout = ply.graph_objs.Layout(
    ...
    scene = dict(
      ...
      zaxis = noaxis,
      aspectmode='manual',
      aspectratio=ply.graph_objs.layout.scene.Aspectratio(
        x=1, y=1, z=1)),
    paper_bgcolor = 'grey',
    plot_bgcolor = 'grey',
    hovermode=False
